  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <input type="email" className="border border-gray-300 py-1.5 px-3.5 w-full" placeholder="E-mail"/>
        ...
        <input type="text" className="border border-gray-300 py-1.5 px-3.5 w-full" placeholder="Region"/>
        </div>
        <div className="flex gap-3">
        ...
        <input type="telephone" className="border border-gray-300 py-1.5 px-3.5 w-full" placeholder="Phone"/>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="w-full text-end mt-8">
            <button onClick={()=>navigate('/orders')} className=" bg-black text-white py-3 px-16 text-sm rounded-md">PLACE ORDER</button>
          </div>
        </div>
      </div>
...
// YALLAH SALIT CHECKOUT PAGE DB ANBDA F ORDERS PAGE D9I9A 4:34
